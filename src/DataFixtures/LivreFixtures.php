...
class LivreFixtures extends Fixture
{
    ...
    {
        $livre = new Livre();
        $livre->setTitre("Ce qu'il faut de haine");
        ...
        $livre = new Livre();
        $livre->setTitre("Chaque seconde compte");
        ...
        $livre = new Livre();
        $livre->setTitre("La Quête de l'Oiseau du Temps");
        ...
        $livre = new Livre();
        $livre->setTitre("Les Chroniques de la Lune noire");
        ...
        $livre = new Livre();
        $livre->setTitre("Boule & Bill - Tome 25");
